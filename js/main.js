...
const add_id = "lujeslrgnmfzmoyk"; // app_id
const app_secret = "aTI5U2pTaUxkMzRyRlNLZmhNU0lvQT09"; // app_secret
const key = "c7de4a559ac44a05b2ace826e064d210" // key
function getWeather() {
...
$('#switchmore').on('click', function () {
    shoemore = !shoemore;
    let fggg =  $(document).width();
    if (shoemore && fggg >= 900) {
        ...
        $("#change").html("你好呀&nbsp;陌生人&nbsp;!");
        $("#change1").html("愿梦到梦寐以求的人，见到日思夜想的人。");
    }
});
...
原Github:  https://github.com/imsyy/home
`
